export const speakers = [
  {
    ...
    longBio: (
      <>
        <p>
          Daniel Sinnathamby is a humanitarian and development professional with
          over 30 years of strategic leadership, organizational development, and
          program management experience with international humanitarian and
          development agencies and networks. He has worked in Asia and Africa
          and has been responsible for program delivery in over 28 countries.
        </p>

        <p>
          He believes that everyone should be able to take part in and benefit
          from their country’s development. Economic growth fairly and
          transparently drives his work and aspirations. He has committed
          himself to ensure the realization of rights and entitlements,
          especially for women, girls, and young people. This commitment also
          includes working towards the effectiveness of institutions and
          movements which represent them.
        </p>

        <p>Daniel’s value propositions include:</p>
        <ul>
          <li>
            Problem-solving and managing complexity. Daniel’s success with
            conceptual and solution-oriented approaches is based on
            human-centric principles which place people, their communities, and
            institutions at the centre.
          </li>

          <li>
            The capability to ensure the relevance and effectiveness of regional
            and country programs amidst uncertainty characterized by changing
            circumstances, contexts, and trends.
          </li>

          <li>
            Developing and implementing approaches for coordination and the
            management of complex inter-organizational relationships,
            acknowledging diversity, and the leadership of multi-cultural teams.
          </li>
        </ul>

        <p>
          Daniel has awe and respect for artisans and creators, loves the
          written word, and is convinced ’doodling’ is Chicken Soup for the
          Soul.
        </p>
      </>
    )
  ...
  },
  {
    ...
    longBio: (
      <>
        <p>
          Jatin Kataria is a GloCal Serial entrepreneur, Innovation &
          Reinvention specialist who has been active in the global startup
          ecosystem for 10+ years, worked with 40+ countries, having a network
          in 100+ countries, represented India 10+ times, and has featured in
          50+ media platforms globally like ET, Doordarshan, TOI, Delo, UNI,
          BBC, etc.
        </p>
        <p>
          He has received 15+ awards like the WYS award to convert UN
          development goals into action & Karmaveer Chakra, been into 100 Saarc
          youth leaders & Top20 of Techstars Apac ecosystem developers.
        </p>
        <p>
          He has been the advisor of many startups with Equity like Drone & EV
          motor manufacturing, Smart street kart, Challenge-based hiring, Solar
          innovation, Electric bikes, Youth mental health, etc. He is also the
          Founder of We Group – Volcano of GloCal Solutions: Strategic,
          reinvention & scaleup think-tank + consulting.
        </p>
        <p>
          He is/was been as Mentor or Advisor of Founder Institute SriLanka,
          Watson Institute the USA, Impact Collective Earth South East Asian
          Countries, Hult Accelerator UK, Challenge Future Europe, Climate
          Collective Launchpad, AIC Raise, SMVDU-TBIC, Google-solve for India,
          CF global summits Europe, GMS Dubai by SRCC-IIMA-IITK, World Leader
          Summit, etc
        </p>
        <p>
          He had been invited as Jury, speaker, and panel member by 100s of
          platforms & organizations like the ICC, Govt of India, Govt of
          Gujarat, IAMAI, NIC, Vibrant Gujarat, Techstars Apac Summit, Challenge
          Future Summits, Youth in Action, Ideation Summit, The Institute of
          Engineers, AIMA, Microtome, LinkedIn mastermind, iHub,
          Think-Do-Impact, CII, Young Innovators Global Award, Zambia Startup
          Pitch, SG Pitch Battle, Startup Russia Traction Program, Ideate for
          India, OGD Hack, GEW India, etc.
        </p>
      </>
    )
  },
  ...
  },
  {
    ...
    longBio: (
      <>
        <p>
          Tuhina Pandey is the Head of Communications for IBM India and South
          Asia. Before IBM, she worked at Tech Mahindra as the Head of Global
          Corporate Communications and Public Affairs. Tuhina was the Vice
          President at Media Training Worldwide, and Associate Editor at Aegis
          News Network. Tuhina has also worked as an anchor and a business
          journalist for NDTV PROFIT and NDTV as an Associate Editor –
          Technology.
        </p>
        <p>
          She also founded and curated com.in, a well-known and renowned
          specialist firm that worked with CEOs, CXOs, and Board Members on
          executive and leadership communications. Her diverse professional
          background includes Business Journalism, Media Training, Executive and
          Leadership Communication, Marketing, Corporate Communication, Digital
          Communication, and Business Intelligence, Analytics consulting, and
          sales across industries.
        </p>
        <p>
          Tuhina is a 'storyteller' and a 'presenter' with international
          experience and a wide range of sensibilities, and one of her main
          ideologies is the power of communication, which can drive the course
          of history. She wants to use her background in bridging the gap
          between business and creativity to assist individuals and
          organizations in telling the most compelling stories in a way that
          inspires action and understanding.
        </p>
        <p>
          Tuhina loves to write, photograph, observe and understand human
          behaviour. Her areas of interest are business, politics, literature,
          documentaries and films, psychology, travel, and most importantly the
          evolving craft of communication. She has published work with the
          University of Pune ‘Bullish on Business’ - A study on Business and
          Economic News on Indian Television in post-liberal India.
        </p>
        <p>
          Tuhina holds a Masters in Communication studies, Media Research with a
  ...
  },
  {
    ...
    longBio: (
      <>
        <p>
          Deepak Justin is a Corporate Trainer, a Motivational Speaker, and a
          Filmmaker. He is known for his quick and easy speaking that has earned
          him the sobriquet, “The Silver Tongued Orator”. He did his BSc. from
          Loyola College and holds an M.A. in English and an M.B.A. in
          Marketing. He has Post Graduate Diplomas in Advertising & Public
          Relations from Madras Christian College and in Training & development
          in which was a Gold Medalist and an All India Topper respectively.
        </p>
        <p>
          As a corporate Trainer, Deejay has trained over one lakh people from
          more than a hundred companies and has given no less than Ten thousand
          Motivational Talks in numerous cities around the globe. His eloquent
          public speaking skills have earned him a lot of accolades. He has been
          a Runner Up at the World Championship of Public Speaking held in
          Washington DC in August 2016 and was ranked among the 30 top speakers
          in the world then he moved on to become the First Runner Up and get
          ranked among the top 20 in the same Championship held at Chicago in
          2018. He is the first in India to achieve a Distinguished Toastmaster
          Certification three times.
        </p>
        <p>
          His heart is as kind as his tongue is gifted. Deepak actively
          participates in Social Service and once delivered 100 speeches of
          different genres continuously for 13 hours to raise funds for a
          Cancer-fighting child.
        </p>
      </>
    )
  },
